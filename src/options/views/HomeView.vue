    ...
    >
        ...
        >
            ...
            <p
                ...
                class="leading-relaxed text-white/90 drop-shadow-sm"
            >
                Manage your anime watch lists, track your progress, and discover new series to enjoy. Built with love
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3
                            ...
                            class="text-lg font-semibold text-white drop-shadow-sm"
                        >
                            Currently Watching
                        </h3>
                        <p
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                >
                    <span
                        ...
                        class="text-xl drop-shadow-sm"
                        >➕</span
                    >
                    <div>
                        <h3 class="font-semibold text-white drop-shadow-sm">Add New Anime</h3>
                        <p class="text-sm text-white/80 drop-shadow-sm">Add a new series to your list</p>
                    </div>
                </button>
                ...
                >
                    ...
                    >
                    <div>
                        <h3 class="font-semibold text-white drop-shadow-sm">View All Lists</h3>
                        <p class="text-sm text-white/80 drop-shadow-sm">Browse your watch lists</p>
                    </div>
                </button>
            </div>
        </div>
